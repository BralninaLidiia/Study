...
// DatabaseLR.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDatabaseLRApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CDatabaseLRApp::OnAppAbout)
...
// Создание CDatabaseLRApp

CDatabaseLRApp::CDatabaseLRApp() noexcept
{
	...
	SetAppID(_T("DatabaseLR.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CDatabaseLRApp

CDatabaseLRApp theApp;


// Инициализация CDatabaseLRApp

BOOL CDatabaseLRApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CDatabaseLRDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CDatabaseLRView));
	if (!pDocTemplate)
		return FALSE;
...
int CDatabaseLRApp::ExitInstance()
{
...
// Обработчики сообщений CDatabaseLRApp
...
void CDatabaseLRApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
