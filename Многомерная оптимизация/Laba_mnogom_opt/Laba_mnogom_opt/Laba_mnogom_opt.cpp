...
// Laba_mnogom_opt.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLabamnogomoptApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLabamnogomoptApp

CLabamnogomoptApp::CLabamnogomoptApp()
{
...
// Единственный объект CLabamnogomoptApp

CLabamnogomoptApp theApp;


// Инициализация CLabamnogomoptApp

BOOL CLabamnogomoptApp::InitInstance()
{
