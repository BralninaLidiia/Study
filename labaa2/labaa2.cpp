...
// labaa2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Clabaa2App, CWinApp)
...
// Единственный объект Clabaa2App

Clabaa2App theApp;


// Инициализация Clabaa2App

BOOL Clabaa2App::InitInstance()
{
