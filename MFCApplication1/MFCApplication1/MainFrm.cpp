...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	((CMFCApplication1Doc*)GetActiveDocument())->pTree =(CMyTreeView*)m_wndSplitter.GetPane(0, 0);
	((CMFCApplication1Doc*)GetActiveDocument())->pView =(CMFCApplication1View*)m_wndSplitter.GetPane(0, 1);

	
	((CMyTreeView*)m_wndSplitter.GetPane(0, 0))->m_pDoc =((CMFCApplication1Doc*)GetActiveDocument());
