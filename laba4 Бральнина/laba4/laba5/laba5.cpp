...
// laba5.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Claba5App, CWinApp)
...
// Единственный объект Claba5App

Claba5App theApp;


// Инициализация Claba5App

BOOL Claba5App::InitInstance()
{
